...
### This is an Adroid infrared application which use irblaster to sends custom crafted commands over IR on<br> `RC6 6A`, `RC6 mode 6 submode 6A 32bit`, `rc6_6a_32` or `RC6_mode_6` protocol
